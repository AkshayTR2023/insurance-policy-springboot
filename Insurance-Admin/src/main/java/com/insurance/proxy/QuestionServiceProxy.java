...
public interface QuestionServiceProxy {
	...
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForAddQuestion")
	...
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForAnswerQuestion")
	...
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForGetAllQuestions")
	@GetMapping(value = "/question", produces = MediaType.APPLICATION_JSON_VALUE)
	public List<Question> getAllQuestions();

	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForGetAllQuestionsByCustomerId")
	...
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForGetQuestionById")
