...
public interface ContactFormServiceProxy {
	...
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForAddContactForm")
	...
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForGetAllContactForms")
	@GetMapping(value = "/contactForm", produces = MediaType.APPLICATION_JSON_VALUE)
	public List<ContactForm> getAllContactForms();
	
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForGetContactFormById")
	...
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForGetContactFormsByName")
