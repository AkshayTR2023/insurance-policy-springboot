...
public interface AddressServiceProxy {
	...
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForAddAddress")
	...
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForUpdateAddress")
	...
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForGetAllAddresses")
	@GetMapping(value = "/address", produces = MediaType.APPLICATION_JSON_VALUE)
	public List<Address> getAllAddresses();

	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForGetAddressById")
	...
	@Retry(name = "admin-feign-retry")
	@CircuitBreaker(name = "admin-feign-cb", fallbackMethod = "fallbackForDeleteAddressById")
