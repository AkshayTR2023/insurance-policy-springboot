...
public interface AdminServiceProxy {
	...
	@CircuitBreaker(name = "insurance-feign-cb", fallbackMethod = "fallbackForRegisterAdmin")
	...
	@Retry(name = "insurance-feign-retry")
	@CircuitBreaker(name = "insurance-feign-cb", fallbackMethod = "fallbackForAdminLoginCheck")
	...
	@Retry(name = "insurance-feign-retry")
	@CircuitBreaker(name = "insurance-feign-cb", fallbackMethod = "fallbackForUpdateAdmin")
	...
	@Retry(name = "insurance-feign-retry")
	@CircuitBreaker(name = "insurance-feign-cb", fallbackMethod = "fallbackForGetAllAdmins")
	@GetMapping(value = "/admin", produces = MediaType.APPLICATION_JSON_VALUE)
	public List<Admin> getAllAdmins();

	@Retry(name = "insurance-feign-retry")
	@CircuitBreaker(name = "insurance-feign-cb", fallbackMethod = "fallbackForGetAdminById")
	...
	@Retry(name = "insurance-feign-retry")
	@CircuitBreaker(name = "insurance-feign-cb", fallbackMethod = "fallbackForGetAdminByEmail")
